...
const translations = {
  en: {
    ...
    "url.input.placeholder": "Enter URL to get extraction help (e.g., https://example.com)",
    "url.fetch.button": "Get Content",
    "url.fetch.loading": "Getting content...",
    ...
    "files.upload.privacy.note": "Privacy: ",
    "files.upload.privacy.description": "All files are processed locally in your browser and never uploaded to any server.",
    ...
    "footer.text": "Context Builder - With Love From @yushaw",
  ...
  zh: {
    ...
    "url.input.placeholder": "输入网址获取提取帮助（如：https://example.com）",
    "url.fetch.button": "获取内容",
    "url.fetch.loading": "正在获取内容...",
    ...
    "files.upload.privacy.note": "隐私保护：",
    "files.upload.privacy.description": "所有文件都在您的浏览器本地处理，绝不会上传到任何服务器。",
    ...
    "footer.text": "上下文构建器 - With Love From @yushaw",
